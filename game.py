...
class Game:
    def __init__(self):
        ...
        self.display = pygame.Surface((320, 240), pygame.SRCALPHA) # Actual surface of the window
    ...
    def run(self):
        ...
        while True:
            ...
            self.display_2.blit(self.assets['background'], (0, 0)) # Covers everything from the last update, refreshing the screen
